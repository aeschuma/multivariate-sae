...
# save results
write_rds(cv_res, file = "../../../Dropbox/dissertation_2/survey-csmf/results/cv/cv_results-multinomial-arealevel.rds")

# if on Box, copy to real dropbox
if (root == "P:/") {
    write_rds(cv_res, file = "C:/Users/aeschuma/Dropbox/dissertation_2/survey-csmf/results/cv/cv_results-multinomial-arealevel.rds")
}
