...
# execute command(s)
Rscript --no-save --no-restore --verbose /home/users/aeschuma/Desktop/survey-csmf/unit-level-simulation/inla-cluster-test.R $a $rr $s > inla-cluster-test_$t.Rout 2>&1
