...
cp stage-2-sim-parallel-TEST_$a_$b_$c_$d_$e_$f_$g_$h_$ii_$j_$k_$l_$m_$n_$o_$p_$q_$r_$s.Rout /home/students/aeschuma/Dropbox/dissertation_2/survey-csmf/out/stage-2-simulation
