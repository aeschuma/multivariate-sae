...
with $\beta_c$ set to be the estimated intercept and $\sigma^2_c$ set to be the estimated variances of the random effects from a model fit to the 2014 KDHS HAZ data. The random effects will only be simulated once and the same ones will be used across all simulations.
